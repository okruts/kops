...
func findNamespace(k8s kubernetes.Interface, name string) (*v1.Namespace, error) {
...
func mutateNamespace(k8s kubernetes.Interface, name string, fn func(s *v1.Namespace) (*v1.Namespace, error)) (*v1.Namespace, error) {
